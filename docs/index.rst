.. olio documentation master file, created by
...
*olio* is a toolkit for modelling the line profile distortions and surface
...
*olio* is available on `Github <https://github.com/vedad/ell>`_. If you run
